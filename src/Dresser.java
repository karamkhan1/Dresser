...
public class Dresser {
    ...
    public static void main(String[] args) {
        Dresser liam = new Dresser(4,1,"Oak", "Dark Stain");
        liam.addToDrawer("Socks");
        liam.addToDrawer("Tee-shirts");
        liam.addToDrawer("Cufflinks");
        liam.addToDrawer("Bowties");
        liam.addToDrawer("Neckties");
        liam.showContents();
        liam.showDetails();
        liam.clearDrawer(2);
        //liam.clearDresser();
